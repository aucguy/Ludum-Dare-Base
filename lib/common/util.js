...
import { fabric } from '/build/lib/fabric.js';
import { injectIntoPhaser, onAssetsLoaded, getAsset } from '/node_modules/aucguy-ludum-dare-base/lib/dev/processAssets.js';
...
var BootScene = extend(Phaser.Scene, 'BootScene', {
  constructor: function BootScene(nextScene) {
    Phaser.Scene.call(this);
    this.preloaded = false;
    this.nextScene = nextScene || null;
  },
